document.addEventListener('DOMContentLoaded', () => {
    ...
    function inicializarTabla() {
        ...
        $('#tablaSolicitudes ').DataTable({
            "ajax": {
                "url": "/mascarasCaptura/php/mostrarSolicitudesTurnadas.php",
                "type": "GET", // Especifica el método GET
                "data": function (d) {
                    // Agrega parámetros GET aquí si es necesario
                    d.operacion = 'mostrarDatos'
                }
            },
            ...
            "columnDefs": [
                {
                    ...
                    "render": function (data, type, row) {
                        return `
                            <a class="btn btn-secondary " data-id="${data}" href="seguimiento_turnos.php?solicitud=${data}" >Ver</a>
                        `;
                    },
