...
<body class="">
    ...
    <div class="container p-3 mt-2 fw-bold">
        <div class='row mb-3'>
            <div class="d-flex justify-content-around rounded-3">
                <a class="navbar-brand bi bi-arrow-left" href="solicitudes_recibidas.php" style="font-size: 1.6rem;"></a>
            ...
            <div class="row " id="datosTramite">
                <div class="col-12 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="mb-3  d-flex justify-content-center">
                        <button type="submit" class="btn btn-secondary col-xl-3 col-md-5 col-sm-4 m-1" id="btnAprobar-solicitud" data-bs-toggle="modal" data-bs-target="#modal-turnar">Aprobar solicitud</button>
                        <button type="submit" class="btn btn-secondary bt-color-secondary col-xl-3 col-md-5 col-sm-4 m-1 fw-bolder" id="btnRegresar-solicitud">Devolver solicitud</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="./Js/seguimientoTramiteRecibidas.js"></script>
</body>
